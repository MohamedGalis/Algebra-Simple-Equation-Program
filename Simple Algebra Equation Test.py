...
for i in range(test_questions):
    ...
    user_answer = get_user_guess(equation)  # If users answer is correct. A point will be awared increasing score=o by +1 

    if user_answer == correct_answer:
        print("✅Correct!\n")
        score += 1 
    else:
        print(f"❌Wrong! The correct answer was {correct_answer}.\n") # If the user input is incorrect it will display this print function
